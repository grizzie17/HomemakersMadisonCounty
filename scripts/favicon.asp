...
FUNCTION favicon_getText()
	...
	s70 = favicon_findImage( sPath, "favicon128" )
	...
	END IF
	sIconPath = favicon_findPNG( sPath, "apple-touch-icon-76x76" )
	IF "" <> sIconPath THEN
		sData = sData & "<link rel=""apple-touch-icon"" sizes=""76x76"" href=""" & sHost & sIconPath & """ />" & vbCRLF
	END IF
	sIconPath = favicon_findPNG( sPath, "apple-touch-icon-120x120" )
	IF "" <> sIconPath THEN
		sData = sData & "<link rel=""apple-touch-icon"" sizes=""120x120"" href=""" & sHost & sIconPath & """ />" & vbCRLF
	END IF
	sIconPath = favicon_findPNG( sPath, "apple-touch-icon-152x152" )
	IF "" <> sIconPath THEN
		sData = sData & "<link rel=""apple-touch-icon"" sizes=""152x152"" href=""" & sHost & sIconPath & """ />" & vbCRLF
	END IF
