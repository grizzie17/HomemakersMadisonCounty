...
FUNCTION remoteExtras( sName )
	DIM	sURL
	sURL = "http://" & g_sDistrictDomain & "/srv_extras.asp?q=" & sName
	remoteExtras = fetchHTTP( sURL )
END FUNCTION



FUNCTION getExtras( sName, nTime )
